...
public class MyPostsCommandHandler implements CommandHandler {

    private final PostController postController;
    private final SecurityComponent securityComponent;

    public MyPostsCommandHandler(PostController postController, SecurityComponent securityComponent) {
