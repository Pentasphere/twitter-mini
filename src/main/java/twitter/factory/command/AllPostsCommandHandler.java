...
public class AllPostsCommandHandler implements CommandHandler {

    private final PostController postController;
    private final SecurityComponent securityComponent;

    public AllPostsCommandHandler(PostController postController, SecurityComponent securityComponent) {
