...
public class PostsByLoginCommandHandler implements CommandHandler {

    private final PostController postController;
    private final SecurityComponent securityComponent;

    public PostsByLoginCommandHandler(PostController postController, SecurityComponent securityComponent) {
