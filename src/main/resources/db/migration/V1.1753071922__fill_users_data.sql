...
insert into twitter_user (login, password, type)
values ('microsoft', 'msft656', 'ORGANIZATION');
insert into twitter_user (login, password, type)
values ('apple', 'appl789', 'ORGANIZATION');
insert into twitter_user (login, password, type)
values ('tesla', 'tesla321', 'ORGANIZATION');
insert into twitter_user (login, password, type)
...
values ((select id from twitter_user where login = 'google'), 'Google LLC', 'Internet services & technologies',
        '1998-09-04');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
values ((select id from twitter_user where login = 'microsoft'), 'Microsoft Corporation', 'Software & Computing',
        '1995-04-04');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
values ((select id from twitter_user where login = 'apple'), 'Apple Inc.', 'Consumer Electronics',
        '1976-04-01');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
values ((select id from twitter_user where login = 'tesla'), 'Tesla Inc.', 'Electronic Vehicles & Clean Energy',
        '2005-07-01');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
values ((select id from twitter_user where login = 'amazon'), 'Amazon.com, Inc.', 'E-commerce & Cloud Computing',
        '1994-07-05');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
values ((select id from twitter_user where login = 'meta'), 'Meta Platform, Inc', 'Social Media & Technology',
        '2004-02-04');
insert into organization_info(twitter_user_id, title, occupation, date_of_foundation)
