...
class UserServiceImplTest {
    ...
    public void createUser_OK(){
        ...
        result.setPassword("$2a$04$H2d1JEtwZHuZkoUXyu8mQunycyFxu9vB6z1lPpyVhu8KA9hWsIX3a");
        ...
        Assertions.assertEquals("$2a$04$H2d1JEtwZHuZkoUXyu8mQunycyFxu9vB6z1lPpyVhu8KA9hWsIX3a", createdUser.getPassword());
